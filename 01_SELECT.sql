...
-- ORA-00904: "PHONE2": 부적합한 식별자 -> 테이블이 없는데 조회할 경우 발생하는 에러
...
-- LIKE : 비교하려는 값이 특정한 패턴이 만족시키면 조회하는 연산자
...
FROM EMPLOYEE
WHERE BONUS IS NULL; -- NULL : 14 // NOT NULL : 9
