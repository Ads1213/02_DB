...
-- 그룹 함수 : N개의 값을 읽어서 연산 후 1개의 결과를 반환

-- 함수는 SELECT 문의
-- SELECT 절, WHERE 절, ORDER BY 절, GROUP BY절, HAVING 절에서 사용 가능
